...
## $\Phi$ as a Lyapunov-like Function
...
Thus, $\Phi$ behaves as a **stochastic Lyapunov-like function**: not strictly decreasing, but directionally aligned with instability and event occurrence.
...
Traditional methods produce single numbers. The Field approach reveals that treatment benefit varies ~4-fold across the state space, with the largest effects in high-BP patients—precisely those for whom the guideline mandates treatment.
...
2. But averages hide structure—HR = 0.55 does not reveal 4-fold variation
