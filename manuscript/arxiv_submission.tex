...
(\textasciitilde4-fold across state space) and explicitly maps regions
...
\subsection{\texorpdfstring{\(\Phi\) as a Lyapunov-like
Function}{\textbackslash Phi as a Lyapunov-like Function}}\label{phi-as-a-lyapunov-like-function}

In many RWD systems, events occur preferentially along trajectories
where:
...
Thus, \(\Phi\) behaves as a \textbf{stochastic Lyapunov-like function}:
not strictly decreasing, but directionally aligned with instability and
event occurrence.
...
increase and local instability structure.
...
\item
  ...
  average effects
\item
  But averages hide structure---HR = 0.55 does not reveal 4-fold
  variation
\item
...
Leizerman, Michael. 2025. {``Unified Causal Field Theory: A Mathematical
Framework for Causal Inference.''} OSF Preprints.
\url{https://doi.org/10.31219/osf.io/68805ae08cbd2c498f1f63d8}.
